...
// boards/:id/cards/:id
router.route("/boards/:board_id(\\d+)/cards/:card_id(\\d+)").get(mainController.getOneCardByBoard).patch(mainController.updateCardFromBoard).delete(mainController.deleteOneCardFromBoard);;
